          ...
          <div>
            ...
            >
              ...
              <div className={classes.crampsbtn}>
                {visible ? (
                  <div className={classes.checkIconTwo}></div>
                ) : (
            ...
            <div>
              {visible && (
                <div className={classes.Qdap}>
                  <div className={classes.TextBox}>
                    <div>
                      <br />
                    </div>
                    <div className={classes.QdapHard}>
                      컨설턴트 기준은 아래와 같습니다.
                    </div>
                    <br />
                    <div className={classes.QdapLight}>
                      - 4년제 대학을 졸업한 패션 디자인 전공자{" "}
                    </div>
                    <div className={classes.QdapLight}>
                      - 패션 및 디자인 관련 분야 5년 이상의 경력자
                    </div>
                    <div className={classes.QdapLight}>
                      - 인스타 팔로워 50만 이상
                    </div>
                    <br />
                    <div className={classes.QdapLight}>
                      위 조건을 만족한 패션 전문가만이 STYLE WITH US의
                      컨설턴트가 될 수 있습니다.
                    </div>
                  </div>
                </div>
