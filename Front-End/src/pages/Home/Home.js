...
import section3Image3 from "../../assets/mainPage/짜증난말풍선.png"
    ...
    <div id="main-page" className={classes["main-page"]}>
      ...
      <div className={classes["section3"]}>
        ...
        <div className={classes.left}>
          ...
          <img src={section3Image3} alt="소개팅녀" />
        </div>
      </div>
      <div className={classes["section4"]}>
        <div className={pageNumber !== 4? classes["right"] : `${classes["right"]} ${classes.on}`}>
          ...
          <img className={pageNumber !== 4? classes["section4-h1"] : `${classes["section4-h1"]} ${classes.on}`} src={section4Image1} alt="회원" />
        </div>
        <div className={pageNumber !== 4? classes["left"] : `${classes["left"]} ${classes.on}`}>
          ...
          <img className={pageNumber !== 4? classes["section4-h1"] : `${classes["section4-h1"]} ${classes.on}`} src={section4Image2} alt="컨설턴트" />
        </div>
      </div>
      <div className={classes["section5"]}>
        <div className={classes.right}>
          <h2 className={pageNumber !== 3? classes["section3-h2"] : `${classes["section3-h2"]} ${classes.on}`}>02</h2>
          <p className={pageNumber !== 3? classes["section3-p1"] : `${classes["section3-p1"]} ${classes.on}`}>전문가에게 받는 것처럼!</p>
          <p className={pageNumber !== 3? classes["section3-p2"] : `${classes["section3-p2"]} ${classes.on}`}>똑똑한 퍼스널 컬러 자가 진단</p>
          <p className={pageNumber !== 3? classes["section3-p4"] : `${classes["section3-p4"]} ${classes.on}`}>실제 전문가에게 받는 것처럼<br/>퍼스널 컬러 자가 진단 서비스를 제공해<br/>사용자 의류 색상 진단에 도움을 드려 똑똑한 의사결정이 가능합니다.</p>
          <img src={section5Image2} alt="colorCircle" />
        </div>
        <div className={classes.left}>
      ...
      <div className={classes["section7"]}>
        <div className={classes.right}>
          <h2 className={pageNumber !== 3? classes["section7-h2"] : `${classes["section7-h2"]} ${classes.on}`}>03</h2>
          <p className={pageNumber !== 3? classes["section7-p1"] : `${classes["section7-p1"]} ${classes.on}`}>다양한 체형 검사를 통한</p>
          <p className={pageNumber !== 3? classes["section7-p2"] : `${classes["section7-p2"]} ${classes.on}`}>의류 추천 서비스</p>
          <p className={pageNumber !== 3? classes["section7-p3"] : `${classes["section7-p3"]} ${classes.on}`}>사용자의 나이, 성별, 체형, 발 사이즈 등<br/>간단하지만 다양한 검사를 통해<br/>사용자에게 적합한 의류 추천 서비스를 제공</p>
        </div>
        <div className={classes.left}>
      ...
      <div className={pageNumber !== 8? classes["section8"] : `${classes["section8"]} ${classes.on}`}>
        ...
        <div className={classes.bottom}>
          ...
          <div className={classes.loading}><span></span><span></span><span></span></div>
