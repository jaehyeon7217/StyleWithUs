    ...
    <div id="main-page" className={classes["main-page"]}>
      ...
      >
        <p
          className={
            pageNumber !== 2
              ? classes["section2-p1"]
              : `${classes["section2-p1"]} ${classes.on}`
          }
        >
          스타일 추천은
        </p>
        <p
          className={
            pageNumber !== 2
              ? classes["section2-p2"]
              : `${classes["section2-p2"]} ${classes.on}`
          }
        >
          왜 STYLE WITH US?
        </p>
        ...
        <div className={classes.right}>
          <h2
            className={
              pageNumber !== 3
                ? classes["section3-h2"]
                : `${classes["section3-h2"]} ${classes.on}`
            }
          >
            01
          </h2>
          <p
            className={
              pageNumber !== 3
                ? classes["section3-p1"]
                : `${classes["section3-p1"]} ${classes.on}`
            }
          >
            스타일 고민은 이제 그만!
          </p>
          <p
            className={
              pageNumber !== 3
                ? classes["section3-p2"]
                : `${classes["section3-p2"]} ${classes.on}`
            }
          >
            실시간 화상 컨설턴트 상담으로
          </p>
          <p
            className={
              pageNumber !== 3
                ? classes["section3-p3"]
                : `${classes["section3-p3"]} ${classes.on}`
            }
          >
            맞춤 스타일 추천 서비스
          </p>
          <p
            className={
              pageNumber !== 3
                ? classes["section3-p4"]
                : `${classes["section3-p4"]} ${classes.on}`
            }
          >
            더 이상 스타일 때문에 소개팅 실패를 걱정할 필요가 없고,
            <br />
            매일 같은 옷을 입는다고 놀림받을 일이 없습니다.
            <br />
            STYLE WITH US가 패션 전문가를 통해 맞춤 스타일을 제공합니다.
          </p>
        </div>
        <div
          className={
      ...
      <div className={classes["section4"]}>
        ...
        >
          <h2
            className={
              pageNumber !== 4
                ? classes["section4-h1"]
                : `${classes["section4-h1"]} ${classes.on}`
            }
          >
            회원
          </h2>
          <p
            className={
              pageNumber !== 4
                ? classes["section4-p1"]
                : `${classes["section4-p1"]} ${classes.on}`
            }
          >
            패션에 관심있는 누구나!
          </p>
          <img
            className={
              pageNumber !== 4
                ? classes["section4-img1"]
                : `${classes["section4-img1"]} ${classes.on}`
            }
            src={section4Image1}
            alt="회원"
          />
        ...
        >
          ...
          >
            패션 디자인을 전공한 5년 이상의 경력자
          </p>
          <img
            className={
              pageNumber !== 4
                ? classes["section4-img2"]
                : `${classes["section4-img2"]} ${classes.on}`
            }
            src={section4Image2}
            alt="컨설턴트"
          />
        ...
        <div className={classes.right}>
          <h2
            className={
              pageNumber !== 5
                ? classes["section5-h2"]
                : `${classes["section5-h2"]} ${classes.on}`
            }
          >
            02
          </h2>
          <p
            className={
              pageNumber !== 5
                ? classes["section5-p1"]
                : `${classes["section5-p1"]} ${classes.on}`
            }
          >
            전문가에게 받는 것처럼!
          </p>
          <p
            className={
              pageNumber !== 5
                ? classes["section5-p2"]
                : `${classes["section5-p2"]} ${classes.on}`
            }
          >
            똑똑한 퍼스널 컬러 자가 진단
          </p>
          <p
            className={
              pageNumber !== 5
                ? classes["section5-p3"]
                : `${classes["section5-p3"]} ${classes.on}`
            }
          >
            실제 전문가에게 받는 것처럼
            <br />
            퍼스널 컬러 자가 진단 서비스를 제공해
            <br />
            사용자 의류 색상 진단에 도움을 드려 똑똑한 의사결정이 가능합니다.
          </p>
          <img
            className={
              pageNumber !== 5
                ? classes["section5-img"]
                : `${classes["section5-img"]} ${classes.on}`
            }
            src={section5Image2}
            alt="colorCircle"
          />
      ...
      >
        <p
          className={
            pageNumber !== 6
              ? classes["section6-p1"]
              : `${classes["section6-p1"]} ${classes.on}`
          }
        >
          자가 퍼스널 컬러 진단 서비스 제공!
        </p>
        <p
          className={
            pageNumber !== 6
              ? classes["section6-p2"]
              : `${classes["section6-p2"]} ${classes.on}`
          }
        >
          봄/가을 웜톤부터 여름/겨울 쿨톤까지 무료로 진단하세요
        </p>
        <div>
        ...
        <div className={classes.right}>
          <h2
            className={
              pageNumber !== 7
                ? classes["section7-h2"]
                : `${classes["section7-h2"]} ${classes.on}`
            }
          >
            03
          </h2>
          <p
            className={
              pageNumber !== 7
                ? classes["section7-p1"]
                : `${classes["section7-p1"]} ${classes.on}`
            }
          >
            다양한 체형 검사를 통한
          </p>
          <p
            className={
              pageNumber !== 7
                ? classes["section7-p2"]
                : `${classes["section7-p2"]} ${classes.on}`
            }
          >
            의류 추천 서비스
          </p>
          <p
            className={
              pageNumber !== 7
                ? classes["section7-p3"]
                : `${classes["section7-p3"]} ${classes.on}`
            }
          >
            사용자의 성별, 체형, 발 사이즈 등<br />
            간단하지만 다양한 검사를 통해
            <br />
            사용자에게 적합한 의류 추천 서비스를 제공
          </p>
        </div>
        <div
          className={
      ...
      >
        <p
          className={
            pageNumber !== 8
              ? classes["section8-p1"]
              : `${classes["section8-p1"]} ${classes.on}`
          }
        >
          진단 시간까지 단 1분!
        </p>
        <p
          className={
            pageNumber !== 8
              ? classes["section8-p2"]
              : `${classes["section8-p2"]} ${classes.on}`
          }
        >
          당신의 스타일을 추천해 드려요
        </p>
        <p
          className={
            pageNumber !== 8
              ? classes["section8-p3"]
              : `${classes["section8-p3"]} ${classes.on}`
          }
        >
          나이와 성별 체형만 입력하면 스타일 고민은 끝
        </p>
        ...
        <div className={classes.right}>
          <h2
            className={
              pageNumber !== 9
                ? classes["section9-h2"]
                : `${classes["section9-h2"]} ${classes.on}`
            }
          >
            04
          </h2>
          <p
            className={
              pageNumber !== 9
                ? classes["section9-p1"]
                : `${classes["section9-p1"]} ${classes.on}`
            }
          >
            패스트패션으로 인한
          </p>
          <p
            className={
              pageNumber !== 9
                ? classes["section9-p2"]
                : `${classes["section9-p2"]} ${classes.on}`
            }
          >
            환경 오염 해소에 동참하는 친환경 사이트
          </p>
          <p
            className={
              pageNumber !== 9
                ? classes["section9-p3"]
                : `${classes["section9-p3"]} ${classes.on}`
            }
          >
            STYLE WITH US는
            <br />
            사용자에게 적합한 의류를 추천해 줌으로써 의류 낭비를 막고
            <br />
            모든 수익금을 패스트패션으로 인한 환경 오염 해결에 기부합니다.
          </p>
        </div>
        <div
          className={
      ...
      <div
        className={
          pageNumber !== 10
            ? classes["section10"]
            : `${classes["section10"]} ${classes.on}`
        }
      >
        <p
          className={
            pageNumber !== 10
              ? classes["section10-p1"]
              : `${classes["section10-p1"]} ${classes.on}`
          }
        >
          한 해 버려지는 옷들만 무려 330억 벌!
        </p>
        <p
          className={
            pageNumber !== 10
              ? classes["section10-p2"]
              : `${classes["section10-p2"]} ${classes.on}`
          }
        >
          의류에서 발생하는 온실가스 배출량은 전 세계 탄소 배출량의 10%
        </p>
        <p
          className={
            pageNumber !== 10
              ? classes["section10-p3"]
              : `${classes["section10-p3"]} ${classes.on}`
          }
        >
          -KBS ‘환경 스폐셜 옷을 위한 지구는 없다’
        </p>
        <div className={classes.bottom}>
      ...
      <div
        className={
          pageNumber !== 11
            ? classes["section11"]
            : `${classes["section11"]} ${classes.on}`
        }
      >
        <p
          className={
            pageNumber !== 11
              ? classes["section11-p1"]
              : `${classes["section11-p1"]} ${classes.on}`
          }
        >
          STYLE WITH US를 통해
        </p>
        <p
          className={
            pageNumber !== 11
              ? classes["section11-p2"]
              : `${classes["section11-p2"]} ${classes.on}`
          }
        >
          나에게 적합한 옷을 찾아 오래오래 입자!
        </p>
      </div>
