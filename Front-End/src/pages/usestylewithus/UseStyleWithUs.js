                        ...
                        <div>
                            <img src={main1} alt="" className={classes.main1}/>
                                <div className={classes.diaryboxtwo}>
                                    ...
                                    <p className={classes.datacontenttwo}>스타일 윗 어스의 다양한 기능이 담긴 </p>
                                    <p className={classes.datacontenttwo}>메인 페이지를 즐기며 서비스 익히기 </p>
                                </div>
                        ...
                        <div className={classes.vLine}></div>
                            <div>
                                <div className={classes.diaryboxone}>
                                    ...
                                    <p className={classes.datenameone}>스타일 윗 어스 사이트 접속하기</p>
                                    <p className={classes.datacontent}>화상 회의 기반의 패션 추천 사이트</p>
                                    <p className={classes.datacontent}>스타일 윗 어스 메인 페이지 접속하기</p>
                                </div>
                            <img src={main2} alt="" className={classes.main2} />
                                <div className={classes.diaryboxone}>
                                    ...
                                    <p className={classes.datacontent}>가입 유형 컨설턴트/일반 유저에 따라  </p>
